...
Mostrar indicadores que muestren las características principales de violencia contra la mujer en Bolivia en base a la  ?Encuesta de Prevalencia y Características de la Violencia contra las Mujeres? (EPCVcM) de la gestión 2016.
...
\begin{itemize}
\item Número de residente en el hogar
\item ¿ Es hombre o mujer?
\item ¿ Cuántos años cumplidos tiene?
\item ¿Qué relación o parentesco tiene (...) con el jefe o jefa del hogar?
\item ¿Cuál es su estado civil o conyugal actual?
\item Departamento
\item Area geografíca
...
\item ¿Quién fue principalmente?
\item En los últimos 12 meses, ¿Cuántas veces ocurrió?
\end{itemize}
\end{document}